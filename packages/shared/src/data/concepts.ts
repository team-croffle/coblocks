...
export const STANDARDS: Standard[] = [
  {
    code: '[6실05-01]',
    band: 'e56',
    text: '컴퓨터를 활용한 생활 속 문제해결 사례를 탐색하고, 일상생활 속 문제를 해결하기 위한 알고리즘을 다양한 방법으로 표현한다.',
  },
  {
    code: '[6실05-02]',
    band: 'e56',
    text: '프로그래밍 도구를 사용하여 기초적인 프로그램을 작성한다.',
  },
  {
    code: '[6실05-03]',
    band: 'e56',
    text: '문제를 해결하는 프로그램을 협력하여 작성하고 공유한다.',
  },
  {
    code: '[9정02-03]',
    band: 'm',
  ...
  { code: '[12정03-06]', band: 'h', text: '다차원 데이터 구조를 활용한 프로그램을 작성한다.' },
  {
    code: '[12정03-09]',
    band: 'h',
    text: '실생활의 문제 해결을 위해 협력하여 프로그램을 설계·구현한다.',
  },
  {
    code: '[12정04-02]',
    band: 'h',
    text: '기계학습의 개념을 이해하고 지도학습과 비지도학습을 비교·분석한다.',
  },
];
