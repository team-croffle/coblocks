...
import { GRADE_BANDS } from '@coblocks/shared';
import type { GradeBand } from '@coblocks/shared';
        ...
        <div className='mx-auto grid max-w-[1180px] items-center gap-14 px-6 lg:grid-cols-[1.15fr_.85fr]'>
          <div>
            ...
            <p className='mb-7 max-w-[34em] text-[17px] text-ink-soft'>
              초등 3학년의 언플러그드 놀이부터 고등학교의 정렬·탐색 알고리즘까지. 블록코딩으로
              시작해 텍스트 코드로 건너가는 한 줄기 학습 경로를, 교육과정 성취기준에 그대로 맞춰
              설계했습니다.
            </p>
      ...
      <section id='how' className='border-b border-line py-14'>
        <div className='mx-auto max-w-[1180px] px-6'>
          ...
          <p className='mb-8 max-w-[46em] text-muted'>
            같은 문제를 세 번 만납니다. 블록으로 만들고, 흐름을 말로 설명하고, 마지막에 텍스트
            코드로 옮깁니다.
          </p>
