...
import { CONCEPTS, GRADE_BANDS, LESSON_SEED, type Lesson } from '@coblocks/shared';
...
export function LessonManagePage() {
  const { data } = useQuery({
    ...
    initialData: { items: LESSON_SEED as Lesson[], total: LESSON_SEED.length, page: 1, pageSize: 200 },
  });
