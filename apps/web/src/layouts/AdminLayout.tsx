...
const LINK = 'block w-full rounded-[9px] px-2.5 py-2 text-left text-sm text-ink-soft hover:bg-surface';
    ...
    <div>
      <header className="sticky top-0 z-40 border-b border-line bg-paper">
        <div className="mx-auto flex max-w-[1180px] flex-wrap items-center gap-4 px-6 py-2.5">
          ...
          <span className="rounded-md bg-algo px-2 py-0.5 text-[11.5px] font-semibold text-white">ADMIN</span>
          <span className="flex-1" />
          <ThemeToggle />
          <Link to="/app/dashboard" className="text-[13.5px] text-muted underline underline-offset-4">
            학습자 화면으로
          </Link>
