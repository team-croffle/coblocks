import { CONCEPTS, GRADE_BANDS, LEVELS, STANDARD_TEXT, type LessonSummary } from '@coblocks/shared';
...
export function LessonDetailModal({ lesson, onClose, onStart }: Props) {
  ...
  return (
    ...
    >
      <div className="max-h-[86vh] w-full max-w-[560px] overflow-auto rounded-[18px] border border-line bg-paper">
        <div className="flex flex-col gap-2.5 px-6 pt-5">
          ...
          <h3 className="text-[23px]">{lesson.title}</h3>
        </div>
