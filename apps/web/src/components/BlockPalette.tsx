import { TURN_STEP, type ProgramBlock } from '@coblocks/shared';
...
const PALETTE: Array<{ key: string; block: ProgramBlock; label: string; cssVar: string }> = [
  ...
  { key: 'turn-right', block: { kind: 'turn', deg: TURN_STEP }, label: '오른쪽으로 돌기', cssVar: '--color-seq' },
  { key: 'turn-left', block: { kind: 'turn', deg: -TURN_STEP }, label: '왼쪽으로 돌기', cssVar: '--color-seq' },
