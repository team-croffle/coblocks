...
const ClassroomLayoutPage = () => {
  // 학생 및 선생님 데이터 상태
  const [role] = useState('student'); // 'teacher' 또는 'student'로 설정 가능
  ...
  return (
    <Container fluid className='p-3'>
      <Row>
        {/* 왼쪽: 학생 배치도 */}
        <Col md={8}>
          <Card className='classroom-layout' style={{ height: '80vh' }}>
            <Card.Body className='d-flex flex-column'>
              ...
              <div className='d-flex justify-content-center mt-3'>
                <Button variant='success' className='px-5' style={{ width: '200px' }} onClick={handleExecute}>
                  실행하기
                </Button>
              </div>
            </Card.Body>
        ...
        {/* 오른쪽: 방 정보 및 학생 목록 */}
        <Col md={4}>
          <Card className='mb-3' style={{ borderColor: 'orange' }}>
            <Card.Body>
              <h4>방 정보</h4>
